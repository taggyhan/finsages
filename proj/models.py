...
class Transaction(models.Model):
    ...
    CATEGORY_CHOICES = (
        ...
        (
            "kids",
            "Kids",
        ),  # Note: You might want to remove or handle this category differently due to having very few entries
        ("medical", "Medical"),
        ("personal_care", "Personal Care"),
        (
            "pets",
            "Pets",
        ),  # Assuming you want to include Pets based on your truncated list
    )
...
class Goal(models.Model):
    ...
    def __str__(self):
        return (
            f"{self.name} - Target: {self.target_amount} - Saved: {self.amount_saved}"
        )
